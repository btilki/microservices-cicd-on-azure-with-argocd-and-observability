...
**Organization in this project:** `btilki` (replace in `CODEOWNERS` and team mentions if your org differs).
...
- Root **`CODEOWNERS`** — prod path → `@btilki/prod-gitops-approvers` and `@btilki/prod-gitops-secondary`
