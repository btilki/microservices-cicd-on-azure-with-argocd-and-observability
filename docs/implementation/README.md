...
One file per phase. Each guide is **action-oriented**: do the **Implementation** steps with your tools (terminal, Git, Azure, Argo CD, Azure DevOps, Helm, etc.). Background and ADRs: [architecture-design.md](../architecture-design.md).
